        ...
        <div className=" row top-box">
          <div className=" col-lg-4 col-md-8 mb-3">
            ...
            <div className="d-md-flex  gap-4">
              ...
              <div class="">
                <div class=" date_box">
                  <label class="input-group-text date_select">
                    <CalendarMonth />
                  </label>
                  <input type="date" name="" placeholder="Create Date" className="date_select user_date"/>
          ...
          <div className="col-md-4 col-lg-8 d-flex justify-content-md-end mb-3">
            <button className="add-btn" onClick={()=> history.push(`/adduser`)}>
              <Add /> Add user
            </button>
          </div>
        </div>
